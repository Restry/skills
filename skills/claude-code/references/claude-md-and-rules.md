# CLAUDE.md, Rules Directory, Memory, Subagents

CC 持久化项目上下文的所有机制 + 自定义 subagent。**何时加载**:要写 CLAUDE.md、分裂为 rules 目录、了解 auto-memory 限额、定义专家 subagent(security-reviewer / db-expert) 时。
